...
const Checkout = () => {
  ...
  const manejadorSubmit = (event) => {
    ...
    //Modificación para que descuente stock: lo que tenemos que hacer es ejecutar varias promesas en paralelo. Por un lado puedo crear la orden de compra y por el otro actualizar el stock.
      ...
      .then(() => {
        addDoc(collection(db, "ordenes"), orden)
          .then((docRef) => {
            ...
            vaciarCarrito();
            //Acá pueden limpiar los input y usar el SweetAlert2 para mostrar el Order ID
